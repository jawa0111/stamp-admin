...
export default function StatusSelect({ order, onUpdated }) {
  ...
  return (
    <select
      ...
      className="cursor-pointer rounded-lg border border-ink-200 bg-surface px-2 py-1.5 text-xs font-medium text-ink-600 transition hover:border-ink-400 focus:outline-none focus:ring-2 focus:ring-primary/25 disabled:opacity-50"
