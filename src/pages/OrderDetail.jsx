                  ...
                  return (
                    <button
                      ...
                      className={`cursor-pointer rounded-xl px-3.5 py-2 text-sm font-medium transition disabled:opacity-50 ${
                        destructive
                          ? 'border border-red-200 dark:border-red-500/30 bg-red-50 dark:bg-red-500/10 text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20 dark:bg-red-500/15'
