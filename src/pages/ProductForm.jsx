    ...
    <form onSubmit={save}>
        ...
        actions={
          <>
            ...
            <button
              ...
              className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-primary shadow-md shadow-primary/20 active:scale-[0.98] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-primary-strong disabled:opacity-50"
            >
                  ...
                  {form.images.map((url, i) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        {i === 0 && (
                          <span className="rounded-md bg-primary shadow-md shadow-primary/20 active:scale-[0.98] px-1.5 py-0.5 text-[10px] font-semibold uppercase text-white">
                            Cover
                          </span>
                        )}
      ...
      <div className="sticky bottom-0 mt-6 flex justify-end gap-2 border-t border-ink-200 bg-ink-100/90 py-3 backdrop-blur lg:hidden">
        <button
          type="submit"
          disabled={saving || uploading}
          className="inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-primary shadow-md shadow-primary/20 active:scale-[0.98] px-5 py-3 text-sm font-semibold text-white transition hover:bg-primary-strong disabled:opacity-50"
        >
